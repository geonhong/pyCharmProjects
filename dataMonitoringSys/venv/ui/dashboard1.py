...
"font: 18pt \"Helvetica Neue\";")
        ...
        self.pane_data.setGeometry(QtCore.QRect(249, 0, 831, 721))
        self.pane_data.setStyleSheet("background-color:white")
        self.pane_data.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.pane_data.setFrameShadow(QtWidgets.QFrame.Raised)
        self.pane_data.setObjectName("pane_data")
        ...
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.pane_data)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(30, 60, 781, 211))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "2019.02.21"))
        self.title_DATE_2.setText(_translate("Dialog", "TEMPERATURE"))
        self.label_2.setText(_translate("Dialog", "22 ℃"))
        self.title_DATE_3.setText(_translate("Dialog", "HUMIDITY"))
        self.label_3.setText(_translate("Dialog", "45 %"))

import geometricMotionBackgrounds_rc
import res_rc
